...
| [terraform_play](terraform_play) | stand up the clsuter group, workspace and attach a local cluster using the [TMC Terraform Provider](https://registry.terraform.io/providers/vmware/tanzu-mission-control/latest) |
